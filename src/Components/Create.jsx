...
const Create = () => {
  ...
  const textColor = useColorModeValue("gray.900", "gray.50");
    ...
    const [category, setCategory] = useState("Choisissez votre Category");
      ...
      uploadTask.on(
        ...
        () => {
          getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
            ...
            setAlertMsg("Votre video est enregistree avec succes");
            setTimeout(() => {
              setAlert(false);
            }, 4000);
          });
    ...
    const deleteImage = () => {
      ...
      deleteObject(deleteRef)
        .then(() => {
          ...
          setAlertMsg("Votre video est enlevee avec succes");
          setTimeout(() => {
            setAlert(false);
          }, 4000);
        })
    ...
    const uploadDetails = async () => {
      try {
        ...
        if (!title && !category && !videoAsset) {
          ...
          setAlertStatus("error");
          setAlertIcon(<IoWarning fontSize={25} />);
          setAlertMsg("Les champs obligatoires sont manquants!");
          setTimeout(() => {
            setAlert(false);
          }, 4000);
          setLoading(false);
          ...
          {!videoAsset ? (
            <FormLabel width="full">
              ...
              >
                ...
                >
                  {loading ? (
                    <Spinner msg={"Telechargement de la video"} progress={progress} />
                  ) : (
                    <>
                      <IoCloudUpload
                        fontSize={30}
